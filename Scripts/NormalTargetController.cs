...
//ノーマル的の制御
public class NormalTargetController : MonoBehaviour
{
    GameObject director;
    bool hit_flag = false;
    ...
    public void Hit()
    {
        Instantiate(HitEffect, this.transform.position + new Vector3(0,6.4f,0), Quaternion.Euler(0,180,0));
        GetComponent<AudioSource>().Play();
        director.GetComponent<GameDirector>().HitNormalTarget();
        hit_flag = false;
    }
